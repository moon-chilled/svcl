...
(progn
  ...
  (defknown %make-simd-pack-512 (fixnum (unsigned-byte 64) (unsigned-byte 64)
      ...
      simd-pack-512
      (flushable movable foldable))
  (defknown %make-simd-pack-512-double (double-float double-float double-float double-float double-float double-float double-float double-float)
  ...
  (defknown %make-simd-pack-512-ub32 ((unsigned-byte 32) (unsigned-byte 32) (unsigned-byte 32) (unsigned-byte 32)
      ...
      (flushable movable foldable))
  (defknown %make-simd-pack-512-ub64 ((unsigned-byte 64) (unsigned-byte 64) (unsigned-byte 64) (unsigned-byte 64) (unsigned-byte 64) (unsigned-byte 64) (unsigned-byte 64) (unsigned-byte 64))
      (simd-pack-512 (unsigned-byte 64))
      (flushable movable foldable))
  (defknown (%simd-pack-512-0 %simd-pack-512-1 %simd-pack-512-2 %simd-pack-512-3 %simd-pack-512-4 %simd-pack-512-5 %simd-pack-512-6 %simd-pack-512-7) (simd-pack-512)
      (unsigned-byte 64)
      (flushable movable foldable))
